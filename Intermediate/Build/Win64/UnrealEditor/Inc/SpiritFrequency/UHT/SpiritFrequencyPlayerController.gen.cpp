...
void EmptyLinkFunctionForGeneratedCodeSpiritFrequencyPlayerController() {}

// ********** Begin Cross Module References ********************************************************
COREUOBJECT_API UClass* Z_Construct_UClass_UClass();
ENGINE_API UClass* Z_Construct_UClass_APlayerController();
ENHANCEDINPUT_API UClass* Z_Construct_UClass_UInputMappingContext_NoRegister();
SPIRITFREQUENCY_API UClass* Z_Construct_UClass_ASpiritFrequencyPlayerController();
SPIRITFREQUENCY_API UClass* Z_Construct_UClass_ASpiritFrequencyPlayerController_NoRegister();
UMG_API UClass* Z_Construct_UClass_UUserWidget_NoRegister();
UPackage* Z_Construct_UPackage__Script_SpiritFrequency();
// ********** End Cross Module References **********************************************************

// ********** Begin Class ASpiritFrequencyPlayerController *****************************************
void ASpiritFrequencyPlayerController::StaticRegisterNativesASpiritFrequencyPlayerController()
{
}
FClassRegistrationInfo Z_Registration_Info_UClass_ASpiritFrequencyPlayerController;
UClass* ASpiritFrequencyPlayerController::GetPrivateStaticClass()
{
	using TClass = ASpiritFrequencyPlayerController;
	if (!Z_Registration_Info_UClass_ASpiritFrequencyPlayerController.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("SpiritFrequencyPlayerController"),
			Z_Registration_Info_UClass_ASpiritFrequencyPlayerController.InnerSingleton,
			StaticRegisterNativesASpiritFrequencyPlayerController,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ASpiritFrequencyPlayerController.InnerSingleton;
}
UClass* Z_Construct_UClass_ASpiritFrequencyPlayerController_NoRegister()
{
	return ASpiritFrequencyPlayerController::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "IncludePath", "SpiritFrequencyPlayerController.h" },
	...
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ASpiritFrequencyPlayerController>::IsAbstract,
	};
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::NewProp_MobileExcludedMappingContexts,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::NewProp_MobileControlsWidgetClass,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_APlayerController,
	(UObject* (*)())Z_Construct_UPackage__Script_SpiritFrequency,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::ClassParams = {
	&ASpiritFrequencyPlayerController::StaticClass,
	"Game",
	&StaticCppClassTypeInfo,
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::PropPointers),
	0,
	0x009003A5u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::Class_MetaDataParams), Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_ASpiritFrequencyPlayerController()
{
	if (!Z_Registration_Info_UClass_ASpiritFrequencyPlayerController.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_ASpiritFrequencyPlayerController.OuterSingleton, Z_Construct_UClass_ASpiritFrequencyPlayerController_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_ASpiritFrequencyPlayerController.OuterSingleton;
}
DEFINE_VTABLE_PTR_HELPER_CTOR(ASpiritFrequencyPlayerController);
ASpiritFrequencyPlayerController::~ASpiritFrequencyPlayerController() {}
// ********** End Class ASpiritFrequencyPlayerController *******************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_novi4600_Documents_GitHub_SpiritFrequency_Source_SpiritFrequency_SpiritFrequencyPlayerController_h__Script_SpiritFrequency_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_novi4600_Documents_GitHub_SpiritFrequency_Source_SpiritFrequency_SpiritFrequencyPlayerController_h__Script_SpiritFrequency_3219605595(TEXT("/Script/SpiritFrequency"),
	Z_CompiledInDeferFile_FID_Users_novi4600_Documents_GitHub_SpiritFrequency_Source_SpiritFrequency_SpiritFrequencyPlayerController_h__Script_SpiritFrequency_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_novi4600_Documents_GitHub_SpiritFrequency_Source_SpiritFrequency_SpiritFrequencyPlayerController_h__Script_SpiritFrequency_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
